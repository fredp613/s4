...
namespace MasterProject.Data.Migrations
{
    ...
    [Migration("20170914015333_CrmContactID")]
    partial class CrmContactID
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity("MasterProject.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.EntityFrameworkCore.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MasterProject.Models.ApplicationUser")
                        .WithMany("Claims")
